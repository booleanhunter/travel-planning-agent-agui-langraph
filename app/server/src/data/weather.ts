...
const WEATHER: Record<City, Record<number, Forecast>> = {
  bangalore: {
    ...
    3:  { high: 33, low: 20, condition: "hot & sunny",         precipitationChance: 0.10 },
    4:  { high: 34, low: 22, condition: "hot, occasional showers", precipitationChance: 0.30 },
    5:  { high: 32, low: 22, condition: "warm, monsoon onset", precipitationChance: 0.50 },
    6:  { high: 28, low: 21, condition: "monsoon, frequent rain", precipitationChance: 0.80 },
    7:  { high: 27, low: 20, condition: "heavy monsoon",       precipitationChance: 0.85 },
    8:  { high: 27, low: 20, condition: "monsoon",             precipitationChance: 0.80 },
    9:  { high: 28, low: 20, condition: "monsoon tapering",    precipitationChance: 0.60 },
    10: { high: 28, low: 20, condition: "pleasant, some rain", precipitationChance: 0.40 },
  ...
  mumbai: {
    ...
    4:  { high: 34, low: 25, condition: "hot & humid",         precipitationChance: 0.10 },
    5:  { high: 34, low: 27, condition: "very hot & humid",    precipitationChance: 0.20 },
    6:  { high: 32, low: 26, condition: "monsoon onset",       precipitationChance: 0.70 },
    7:  { high: 30, low: 25, condition: "heavy monsoon",       precipitationChance: 0.90 },
    8:  { high: 29, low: 25, condition: "monsoon",             precipitationChance: 0.85 },
    9:  { high: 30, low: 24, condition: "monsoon tapering",    precipitationChance: 0.60 },
    10: { high: 33, low: 23, condition: "hot, humid",          precipitationChance: 0.20 },
  ...
  barcelona: {
    1:  { high: 13, low: 5,  condition: "cool, occasional rain", precipitationChance: 0.30 },
    2:  { high: 14, low: 6,  condition: "cool",                precipitationChance: 0.30 },
    3:  { high: 17, low: 8,  condition: "mild",                precipitationChance: 0.25 },
    4:  { high: 19, low: 10, condition: "spring, mild",        precipitationChance: 0.30 },
    ...
    7:  { high: 29, low: 21, condition: "hot & sunny",         precipitationChance: 0.10 },
    8:  { high: 30, low: 22, condition: "hot & sunny",         precipitationChance: 0.10 },
    9:  { high: 27, low: 19, condition: "warm",                precipitationChance: 0.25 },
    10: { high: 23, low: 15, condition: "mild autumn",         precipitationChance: 0.35 },
    11: { high: 18, low: 10, condition: "cool, autumn rain",   precipitationChance: 0.40 },
